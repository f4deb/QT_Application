...
#include <memory>
#include "../../robot_client/terminal.h"
...
QT_MOC_LITERAL(4, 23, 22), // "openSerialPortTerminal"
QT_MOC_LITERAL(5, 46, 23), // "closeSerialPortTerminal"
QT_MOC_LITERAL(6, 70, 34) // "on_bouton_serial_connexion_cl..."
...
void Terminal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Terminal::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Terminal::openSerialPortTerminal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Terminal::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Terminal::closeSerialPortTerminal)) {
                *result = 2;
                return;
            }
        }
