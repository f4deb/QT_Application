...
QT_INIT_METAOBJECT const QMetaObject LEDPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_LEDPlugin.data,
    qt_meta_data_LEDPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    0xbf, 
    // "IID"
    0x02,  0x78,  0x18,  'c',  'o',  'm',  '.',  'i', 
    'c',  's',  '.',  'Q',  't',  '.',  'C',  'u', 
    's',  't',  'o',  'm',  'W',  'i',  'd',  'g', 
    'e',  't',  's', 
    // "className"
    0x03,  0x69,  'L',  'E',  'D',  'P',  'l',  'u', 
    'g',  'i',  'n', 
    0xff, 
};
